...
@RestController
@RequestMapping("/api/employeeportal-kafka")
public class EmployeeportalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EmployeeportalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EmployeeportalKafkaResource(KafkaProperties kafkaProperties) {
